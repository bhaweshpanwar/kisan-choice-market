  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-500 text-white hover:bg-red-500/90 rounded-none",
        outline:
          "border border-gray-300 bg-transparent hover:bg-gray-100 hover:text-black rounded-none",
        secondary:
          "bg-gray-100 text-black hover:bg-gray-200 rounded-none",
        ghost: "hover:bg-gray-100 hover:text-black rounded-none",
        link: "text-black underline-offset-4 hover:underline rounded-none",
      },
      size: {
